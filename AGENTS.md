...
- per-subproject commands (uv/pytest/alembic for the server; xcodegen/xcodebuild for iOS) and architecture (router → service → repository on the server; Views → State → Networking → Models on iOS).
